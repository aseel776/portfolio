  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <svg className="absolute bottom-0 left-0 w-full h-48 md:h-64" viewBox="0 0 1440 320" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" className="[stop-color:hsl(var(--primary))]" stopOpacity="0.6" />
              <stop offset="100%" className="[stop-color:hsl(var(--primary))]" stopOpacity="0.2" />
            </linearGradient>
            <linearGradient id="gradient2" x1="100%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" className="[stop-color:hsl(var(--accent))]" stopOpacity="0.4" />
              <stop offset="100%" className="[stop-color:hsl(var(--accent))]" stopOpacity="0.1" />
            </linearGradient>
          </defs>
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            Specializing in Flutter mobile development and React web applications.
